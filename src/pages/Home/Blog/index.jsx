  ...
  return (
    <Container>
        <Row className='align-items-center justify-content-center'>
            ...
            >
                <SwiperSlide ><img src="https://flone.jamstacktemplates.dev/assets/img/blog/blog-1.jpg" alt="blog" className='img-fluid' /></SwiperSlide>
                <SwiperSlide ><img src="https://flone.jamstacktemplates.dev/assets/img/blog/blog-2.jpg" alt="blog" className='img-fluid' /></SwiperSlide>
                <SwiperSlide ><img src="https://flone.jamstacktemplates.dev/assets/img/blog/blog-3.jpg" alt="blog" className='img-fluid' /></SwiperSlide>
            </Swiper>
            </Col>
